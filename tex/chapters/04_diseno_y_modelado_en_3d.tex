...
\begin{document}
  ...
  \label{chap:4}
    ...
    %% TODO: Insertar imagen del detalle de la cara de alguna de las figuras
    \paragraph{}
    ...
    %% TODO: Insertar imagen de textura antes vs textura después
    \paragraph{}
    ...
    %% TODO: captura de los huesos del modelo
    \paragraph{}
    ...
    %% TODO: captura de la posición del modelo
