...
\end{lstlisting}
        ...
        \paragraph{}
        Una vez tenemos el objeto del modelo, %% carga de modelos + carga de animaciones

        \paragraph{}
        Por último, antes de lanzar la función \textit{load}, %% no olvidar inicialización de clock

        %% reproducción de animación
        %% comentar también el evento onTouch -> lanzar animacion, relanzar animacion, ubicar modelo 
        ...
        \label{sec:3.5}
        %% resumen de cómo queda finalmente caso de uso
