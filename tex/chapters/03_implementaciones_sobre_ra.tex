...
\begin{lstlisting}[language=JavaScript, float, caption={Solicitud de Hit Test Source a la Sesión.}, label={lst:3.4}]
async startLoop() {
...
\end{lstlisting}
        ...
        Antes de terminar con la función \textit{startLoop}, prepararemos un evento que servirá para aplicar la funcionalidad de la aplicación que funciona gracias a \hittest. Como vemos en el código XXXX en la línea XXXX, mediante la función \textit{addEventListener} de la Sesión, %% TODO continuar
