...
\pagenumbering{arabic}
        ...
        \caption[Espectro entre un entorno real y un entorno virtual]{Espectro entre un entorno real y un entorno virtual. Fuente: \citetitle{web:wikipedia_realidad_aumentada}}
        ...
        \caption[Meta Quest 2 para \textit{RV} (izq.) y Microsoft Hololens para \textit{RA} (der.)]{Meta Quest 2 para \textit{RV} (izq.) y Microsoft Hololens para \textit{RA} (der.). Fuentes: \citetitle{web:meta_quest2} y \citetitle{web:microsoft_hololens}}
        ...
        \caption[Representación de la diferencia de tiempo interaural (izq.) y de la diferencia de nivel interaural (der.)]{Representación de la diferencia de tiempo interaural (izq.) y representación de la diferencia de nivel interaural (der.). Fuente: \citetitle{art:mroz_spatialaudio}}
        \label{fig:ITD_ILD}
        \end{figure}
